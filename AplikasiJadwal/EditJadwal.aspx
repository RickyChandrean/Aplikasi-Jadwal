<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditJadwal.aspx.cs" Inherits="AplikasiJadwal.EditJadwal" %>
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="1" style="margin-top: 1px">
                ...
                <div class="form-group">
                    <asp:Label ID="Label0" runat="server" Text="Kode Dosen"></asp:Label>
                ...
                <br />
                <asp:Button ID="btnSubmit" runat="server" Text="Ubah" CssClass="btn btn-warning" OnClick="btnSubmit_Click" />
                &nbsp
                <asp:HyperLink ID="hyperlink1" runat="server" CssClass="btn btn-primary" NavigateUrl="~/Jadwal.aspx">Kembali</asp:HyperLink>
            </div>
        </div>
    </div>
</asp:Content>
